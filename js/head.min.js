...
$.ajax({url:a,type:"GET",dataType:"html",success:function(b){$("body").prepend(b)
...
e="multi";
break;
case"p11-takeover-base":c=h.parent().find(".a-link.with-anchor");
break;
...
break;
case"p11-takeover-base":c=h.parents(".a-link.with-anchor");
break;
